...
/**
 * Source:
 * http://stackoverflow.com/questions/9288350/adding-vertical-scroll-to-a
 * -jpopupmenu
 * 
 * @author thomas
 * 
    ...
    public static void main(String[] args) {
        new BasicGui(JScrollPopupMenu.class.getName()) {
            ...
            protected void layoutPanel() {
                final MigPanel panel = new MigPanel("ins 5,wrap 1", "[grow,fill]", "[][grow,fill]");
                ...
                panel.addMouseListener(new MouseListener() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        JScrollPopupMenu p = new JScrollPopupMenu();
                        int i = 1;
                        p.add(new JMenuItem("a " + (i++)));
                        p.add(new JMenuItem("a " + (i++)));
                        p.add(new JMenuItem("a " + (i++)));
                        p.add(new JMenuItem("a " + (i++)));
                        p.add(new JMenuItem("a " + (i++)));
