    ...
    public FXPathChooser(final String id, final boolean useQuickLIst) {
        ...
        this.textField = new TextField() {
            ...
            public JPopupMenu getPopupMenu(final AbstractAction cutAction, final AbstractAction copyAction, final AbstractAction pasteAction, final AbstractAction deleteAction, final AbstractAction selectAction) {
                final JPopupMenu self = FXPathChooser.this.getPopupMenu(FXPathChooser.this.txt, cutAction, copyAction, pasteAction, deleteAction, selectAction);
        ...
        if (useQuickLIst) {
            ...
            this.destination.getTextField().getActionMap().put("auto", new AbstractAction() {
                ...
                @Override
                public void actionPerformed(final ActionEvent e) {
                    if (!FXPathChooser.this.auto(FXPathChooser.this.txt)) {
                        //
